...
use codecrafters_redis::rdb::from_rdb;
use codecrafters_redis::storage::Storage;

// ---------------------------------------------------------------------------
// CRC64 helper (same algorithm as rdb.rs, duplicated here since it's private)
// ---------------------------------------------------------------------------

/// Redis-compatible CRC64 table. Mirrors the algorithm in Redis src/crc64.c:
/// MSB-first CRC with reflected I/O, polynomial 0xad93d23594c935a9.
const CRC64_TABLE: [u64; 256] = {
    ...
    const fn single_byte(byte: u8) -> u64 {
        let mut crc: u64 = 0;
